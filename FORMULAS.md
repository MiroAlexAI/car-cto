...
Калькулятор использует модель **NPV (Net Present Value)** для приведения будущих расходов к текущей стоимости денег, учитывая инфляцию и альтернативную доходность (дисконт).
